...
Begin VB.Form frmMain 
   ...
   Begin VB.CheckBox cmdMiniMap 
      ...
      Width           =   195
   End
   Begin Compressor.uAOButton cmdCerrar 
      Height          =   375
      Left            =   6000
      TabIndex        =   11
      Top             =   360
   ...
   Begin VB.TextBox txtContra 
      ...
      Width           =   1815
   End
   Begin Compressor.uAOButton cmdComprimirMaps 
      Height          =   615
      Left            =   4080
      TabIndex        =   1
      Top             =   960
   ...
   Begin MSComctlLib.ProgressBar StatusBar 
      ...
      Scrolling       =   1
   End
   Begin Compressor.uAOButton cmdDescomprimirMaps 
      Height          =   615
      Left            =   4080
      TabIndex        =   3
      Top             =   1560
      ...
      EndProperty
   End
   Begin Compressor.uAOButton cmdParcheMaps 
      Height          =   615
      Left            =   4080
      TabIndex        =   5
      Top             =   2160
      ...
      EndProperty
   End
   Begin Compressor.uAOButton cmdAplicarMaps 
      Height          =   615
      Left            =   4080
      TabIndex        =   7
      Top             =   2760
      ...
      EndProperty
   End
   Begin Compressor.uAOButton cmdComprimirGrh 
      Height          =   615
      Left            =   1800
      TabIndex        =   0
      Top             =   960
      ...
      EndProperty
   End
   Begin Compressor.uAOButton cmdDescomprimirGrh 
      Height          =   615
      Left            =   1800
      TabIndex        =   2
      Top             =   1560
      ...
      EndProperty
   End
   Begin Compressor.uAOButton cmdParcheGrh 
      Height          =   615
      Left            =   1800
      TabIndex        =   4
      Top             =   2160
      ...
      EndProperty
   End
   Begin Compressor.uAOButton cmdAplicarGrh 
      Height          =   615
      Left            =   1800
      TabIndex        =   6
      Top             =   2760
